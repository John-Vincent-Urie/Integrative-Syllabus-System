 ...
 * @author Urie_Diska
 */
public class Signup_for_client extends javax.swing.JFrame {

  
    public Signup_for_client() {
        initComponents();
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try (Connection conn = DBConnection.connectDB();
             PreparedStatement stmt = conn.prepareStatement("INSERT INTO client (client_name, client_password ) VALUES (?, ?)")) {

            stmt.setString(1, user);
            stmt.setString(2, password);  // Secure: Implement password hashing
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        this.dispose();
        Login_for_client LoginFrame = new Login_for_client(); 
        LoginFrame.setVisible(true);
        LoginFrame.setLocationRelativeTo(null);
