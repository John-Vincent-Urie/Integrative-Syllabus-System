...
import java.sql.*;
public class Login_for_client extends javax.swing.JFrame {

   
    public Login_for_client() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        passwordo.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                passwordoActionPerformed(evt);
            }
        });
        ...
        jButton2.setForeground(new java.awt.Color(255, 25, 25));
        ...
        LeftLayout.setVerticalGroup(
            ...
            .addGroup(LeftLayout.createSequentialGroup()
                ...
                .addComponent(jLabel3)
                .addGap(18, 18, 18)
                .addComponent(passwordo, javax.swing.GroupLayout.PREFERRED_SIZE, 34, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
    ...
    private void bt_loginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bt_loginActionPerformed
        ...
        try (Connection conn = DBConnection.connectDB();
            ...
            if (rs.next()) {
                data = rs.getInt("client_id");
                String storedPassword = rs.getString("client_password");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        this.dispose();
        Signup_for_client SignupFrame = new Signup_for_client(); 
